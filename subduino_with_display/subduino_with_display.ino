...
// Display support
#include <ArducamSSD1306.h> // ModTemification of Adafruit_SSD1306 for ESP8266 compatibility
...
#define DISPLAY_RESET         16  // Pin 15 -RESET digital signal
...
byte gDisplayUpdateInterval = 0;
unsigned long gTimeLast = 0;
unsigned long gTimeCurrent = 0;

ArducamSSD1306 display(DISPLAY_RESET); // FOR I2C
